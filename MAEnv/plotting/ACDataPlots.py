...
class ACDataPlots(ACDataOut):
    ...
    def plot_Commands(self, y_lim_sx=(None, None), y_lim_dx=(None, None), show_grid=False, legend_loc='best',
                      export_pdf=True):
        fig = plt.figure(figsize=(12.3, 5))
    ...
    def plot_EulerAng(self, y_lim_sx=(None, None), y_lim_dx=(None, None), show_grid=False, legend_loc='best',
                      export_pdf=True):
        fig = plt.figure(figsize=(12.3, 5))
    ...
    def plot_AlphaBetaV(self, y_lim_sx=(None, None), y_lim_dx=(None, None), show_grid=False, legend_loc='best',
                        export_pdf=True):
        fig = plt.figure(figsize=(12.3, 5))
    ...
    def plot_AltitudeVelocity(self, y_lim_sx=(None, None), y_lim_dx=(None, None), show_grid=False, legend_loc='best',
                              export_pdf=True):
        fig = plt.figure(figsize=(12.3, 5))
    ...
    def plot_LatitLongit(self, y_lim_sx=(None, None), y_lim_dx=(None, None), show_grid=False, legend_loc='best',
                         export_pdf=True):
        fig = plt.figure(figsize=(12.3, 5))
    ...
    def plot_AdvRatioCT(self, y_lim_sx=(None, None), y_lim_dx=(None, None), show_grid=False, legend_loc='best',
                        export_pdf=True):
        fig = plt.figure(figsize=(12.3, 5))
    ...
    def plot_PropRPMV(self, y_lim_sx=(None, None), y_lim_dx=(None, None), show_grid=False, legend_loc='best',
                      export_pdf=True):
        fig = plt.figure(figsize=(12.3, 5))
    ...
    def plot_ThrustPow(self, y_lim_sx=(None, None), y_lim_dx=(None, None), show_grid=False, legend_loc='best',
                       export_pdf=True):
        fig = plt.figure(figsize=(12.3, 5))
    ...
    def plot_GroundTrack(self, units='m', show_grid=False, n_arrows=10, arrow_size=2, export_pdf=True):
        ...
        if units == 'm':
            ...
            print('Error: invalid unit. Only "m" or "ft" allowed')
