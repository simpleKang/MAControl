...
os.system("python ./execute_Probability.py --numU=10 "
          ...
          "--q1=0.1458 --q1=0.6653 --q1=0.1889 "
          "--q2=0.0315 --q2=0.9064 --q2=0.0621 "
          "--q3=0.0171 --q3=0.8606 --q3=0.1223 "
...
os.system("python ./execute_Probability.py --numU=15 "
          ...
          "--p2=0.4 --p2=0.2 --p2=0.4 "
          "--p3=0.4 --p3=0.4 --p3=0.2 "
          "--q1=0.1675 --q1=0.7937 --q1=0.0388 "
          "--q2=0.1606 --q2=0.7188 --q2=0.1206 "
          "--q3=0.0018 --q3=0.9015 --q3=0.0967 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=20 "
          ...
          "--p2=0.4 --p2=0.2 --p2=0.4 "
          "--p3=0.4 --p3=0.4 --p3=0.2 "
          "--q1=0.1611 --q1=0.5457 --q1=0.2932 "
          "--q2=0.1285 --q2=0.4256 --q2=0.4459 "
          "--q3=0.0942 --q3=0.9045 --q3=0.0013 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=25 "
          ...
          "--p2=0.4 --p2=0.2 --p2=0.4 "
          "--p3=0.4 --p3=0.4 --p3=0.2 "
          "--q1=0.2259 --q1=0.3430 --q1=0.4311 "
          "--q2=0.1939 --q2=0.1026 --q2=0.7035 "
          "--q3=0.1329 --q3=0.6738 --q3=0.1933 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=30 "
          ...
          "--p2=0.4 --p2=0.2 --p2=0.4 "
          "--p3=0.4 --p3=0.4 --p3=0.2 "
          "--q1=0.0129 --q1=0.0141 --q1=0.9730 "
          "--q2=0.1340 --q2=0.2475 --q2=0.6185 "
          "--q3=0.1081 --q3=0.8137 --q3=0.0782 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=35 "
          ...
          "--p2=0.4 --p2=0.2 --p2=0.4 "
          "--p3=0.4 --p3=0.4 --p3=0.2 "
          "--q1=0.1520 --q1=0.2741 --q1=0.5739 "
          "--q2=0.0237 --q2=0.0606 --q2=0.9157 "
          "--q3=0.0211 --q3=0.6347 --q3=0.3442 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=40 "
          ...
          "--p2=0.4 --p2=0.2 --p2=0.4 "
          "--p3=0.4 --p3=0.4 --p3=0.2 "
          "--q1=0.0290 --q1=0.3269 --q1=0.6441 "
          "--q2=0.0544 --q2=0.0495 --q2=0.8961 "
          "--q3=0.0083 --q3=0.5993 --q3=0.3924 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=45 "
          ...
          "--p2=0.4 --p2=0.2 --p2=0.4 "
          "--p3=0.4 --p3=0.4 --p3=0.2 "
          "--q1=0.1282 --q1=0.2297 --q1=0.6421 "
          "--q2=0.0938 --q2=0.0648 --q2=0.8414 "
          "--q3=0.0961 --q3=0.7038 --q3=0.2001 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
