...
os.system("python ./execute_Probability.py --numU=10 "
          ...
          "--p2=0.45 --p2=0.1  --p2=0.45 "
          "--p3=0.45 --p3=0.45 --p3=0.1 "
          "--q1=0.1389 --q1=0.5883 --q1=0.2728 "
          "--q2=0.0002 --q2=0.8853 --q2=0.1145 "
          "--q3=0.0195 --q3=0.9777 --q3=0.0028 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=15 "
          ...
          "--p2=0.45 --p2=0.1  --p2=0.45 "
          "--p3=0.45 --p3=0.45 --p3=0.1 "
          "--q1=0.1507 --q1=0.7751 --q1=0.0742 "
          "--q2=0.1117 --q2=0.7254 --q2=0.1629 "
          "--q3=0.0506 --q3=0.9374 --q3=0.0120 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=20 "
          ...
          "--p2=0.45 --p2=0.1  --p2=0.45 "
          "--p3=0.45 --p3=0.45 --p3=0.1 "
          "--q1=0.0689 --q1=0.5196 --q1=0.4115 "
          "--q2=0.0360 --q2=0.1404 --q2=0.8236 "
          "--q3=0.0036 --q3=0.7667 --q3=0.2297 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=35 "
          ...
          "--p2=0.45 --p2=0.1  --p2=0.45 "
          "--p3=0.45 --p3=0.45 --p3=0.1 "
          "--q1=0.0705 --q1=0.2392 --q1=0.6903 "
          "--q2=0.1854 --q2=0.0165 --q2=0.7981 "
          "--q3=0.0415 --q3=0.7982 --q3=0.1603 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=40 "
          ...
          "--p2=0.45 --p2=0.1  --p2=0.45 "
          "--p3=0.45 --p3=0.45 --p3=0.1 "
          "--q1=0.0158 --q1=0.4439 --q1=0.5403 "
          "--q2=0.0355 --q2=0.1877 --q2=0.7768 "
          "--q3=0.1048 --q3=0.6076 --q3=0.2876 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
...
os.system("python ./execute_Probability.py --numU=45 "
          ...
          "--p2=0.45 --p2=0.1  --p2=0.45 "
          "--p3=0.45 --p3=0.45 --p3=0.1 "
          "--q1=0.0645 --q1=0.0096 --q1=0.9259 "
          "--q2=0.0749 --q2=0.0469 --q2=0.8782 "
          "--q3=0.0833 --q3=0.8239 --q3=0.0928 "
          "--typeT=1 --typeT=3 --typeT=1 --typeT=1 --typeT=3 --typeT=2 --typeT=1 --typeT=2 --typeT=2 --typeT=1 ")
